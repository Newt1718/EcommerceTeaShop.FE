  ...
  return (
    <div className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-10 py-6 md:py-10 font-display bg-background-light text-[#0d1b10] min-h-screen">
      ...
      <nav className="flex flex-wrap gap-2 pb-6 text-sm">
        ...
        <Link to="/shop" className="text-gray-500 hover:text-primary transition-colors font-medium">Shop All</Link>
        <span className="text-gray-300">/</span>
        ...
        <div className="flex flex-col-reverse md:flex-row gap-4">
          <div className="flex md:flex-col gap-3 overflow-x-auto md:overflow-y-auto md:max-h-[600px] no-scrollbar pb-2 md:pb-0">
            {thumbnails.map((src, idx) => (
              <div key={idx} className={`shrink-0 cursor-pointer border-2 rounded-xl overflow-hidden size-20 md:size-24 transition-all ${idx === 0 ? 'border-primary opacity-100' : 'border-transparent hover:border-primary/50 opacity-70 hover:opacity-100'}`}>
                <img src={src} alt="Matcha detail" className="w-full h-full object-cover" />
              </div>
            ))}
          </div>
          
          <div className="flex-1 h-[400px] md:h-[600px] rounded-3xl overflow-hidden bg-surface-light relative shadow-sm group">
            <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuBrewoKaXLMrEZ4IUJ4r36tnvbx6wRvho0FgyZRhyg4g1tWMgCC9JNvpaUPGXnWf43zywul4fHM7RSUSk90gP2-8xBcKGJghSJv2au41hKft1z41O1eR1xUn8T-ybVPM8trlhaTqqQSmddsaYPr5L78486YKCH4kMP0IBU63veOWEn94PaCuw-UCECgI6S-TrCX9QjLK08s4pZlO-v5HP19vDvnAB2oioVd4f12-c0OBUAxZY39hhQkzhzvN8uuPJK5NPYcXMkValXL" alt="High quality ceremonial matcha" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
        ...
        <div className="flex flex-col gap-6">
          <div>
            <div className="flex items-center gap-1 text-amber-400 mb-3">
              ...
              <span className="material-symbols-outlined text-[16px] font-variation-settings-'FILL'1">star</span>
              <span className="material-symbols-outlined text-[16px] font-variation-settings-'FILL'1">star</span>
              <span className="material-symbols-outlined text-[16px] font-variation-settings-'FILL'1">star_half</span>
              <span className="ml-2 text-gray-500 text-sm font-bold underline cursor-pointer hover:text-primary transition-colors">4.8 (124 Reviews)</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tight text-[#0d1b10] mb-2">Ceremonial Grade Matcha</h1>
            <p className="text-2xl font-black text-primary">$24.00</p>
          </div>
          
          <p className="text-base leading-relaxed text-gray-600 font-medium">
            Stone-ground, shade-grown green tea from Uji, Japan. This premium ceremonial grade matcha is rich in antioxidants with a smooth, vegetal flavor, creamy texture, and natural sweetness without bitterness.
          </p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-3">
              <button className="px-6 py-2.5 rounded-xl border-2 border-primary bg-primary/10 text-[#0d1b10] font-bold transition-all shadow-sm">30g</button>
              <button className="px-6 py-2.5 rounded-xl border-2 border-gray-200 hover:border-primary text-gray-500 hover:text-[#0d1b10] font-bold transition-all">50g</button>
              <button className="px-6 py-2.5 rounded-xl border-2 border-gray-200 hover:border-primary text-gray-500 hover:text-[#0d1b10] font-bold transition-all">100g</button>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <div className="flex items-center border-2 border-gray-200 rounded-xl h-14 w-32 overflow-hidden bg-white">
              <button className="w-10 h-full flex items-center justify-center hover:bg-gray-100 text-gray-500 transition-colors">
                <span className="material-symbols-outlined text-sm">remove</span>
              </button>
              <input type="text" readOnly value="1" className="flex-1 w-full h-full text-center bg-transparent border-none focus:ring-0 p-0 font-black text-[#0d1b10]" />
              <button className="w-10 h-full flex items-center justify-center hover:bg-gray-100 text-gray-500 transition-colors">
      ...
      <div className="mt-24">
        <div className="flex border-b border-gray-200 mb-8 overflow-x-auto no-scrollbar">
          <button className="px-8 py-4 border-b-4 border-primary text-[#0d1b10] font-black whitespace-nowrap">Description</button>
          <button className="px-8 py-4 border-b-4 border-transparent hover:border-gray-300 text-gray-400 hover:text-gray-600 font-bold whitespace-nowrap transition-all">Brewing Guide</button>
          <button className="px-8 py-4 border-b-4 border-transparent hover:border-gray-300 text-gray-400 hover:text-gray-600 font-bold whitespace-nowrap transition-all">Origin</button>
          <button className="px-8 py-4 border-b-4 border-transparent hover:border-gray-300 text-gray-400 hover:text-gray-600 font-bold whitespace-nowrap transition-all">Reviews (124)</button>
        </div>

        <div className="grid md:grid-cols-3 gap-12">
          <div className="md:col-span-2 space-y-6">
            <h3 className="text-2xl font-black text-[#0d1b10]">The Essence of Uji</h3>
            <p className="text-gray-600 font-medium leading-relaxed">
              Our Ceremonial Grade Matcha is sourced directly from a family-owned estate in Uji, Kyoto—the birthplace of Japanese matcha. The leaves are shade-grown for 20 days before harvest to boost chlorophyll and L-theanine levels, resulting in a vibrant emerald green color and a profound umami flavor.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mt-10">
              <div className="bg-surface-light p-6 rounded-2xl border border-gray-100">
                <h4 className="font-black text-lg mb-4 flex items-center gap-2 text-[#0d1b10]">
                  <span className="material-symbols-outlined text-primary">psychiatry</span> Tasting Notes
                </h4>
                <ul className="space-y-3 text-gray-600 font-medium">
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Creamy mouthfeel</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Vegetal greens</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Subtle sweetness</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Zero bitterness</li>
                </ul>
              </div>
              <div className="bg-surface-light p-6 rounded-2xl border border-gray-100">
                <h4 className="font-black text-lg mb-4 flex items-center gap-2 text-[#0d1b10]">
                  <span className="material-symbols-outlined text-primary">nutrition</span> Benefits
                </h4>
                <ul className="space-y-3 text-gray-600 font-medium">
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>High in antioxidants</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Boosts metabolism</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Calm focus (L-theanine)</li>
                  <li className="flex items-center gap-2"><span className="w-1.5 h-1.5 rounded-full bg-primary"></span>Detoxifies naturally</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#ecf6ee] rounded-3xl p-8 border border-primary/20 h-fit">
            <h4 className="text-xl font-black mb-8 text-center text-[#0d1b10]">Perfect Brew</h4>
            <div className="space-y-6">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-[10px] uppercase font-black tracking-widest text-gray-400">Temperature</p>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-[10px] uppercase font-black tracking-widest text-gray-400">Whisk Time</p>
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  <p className="text-[10px] uppercase font-black tracking-widest text-gray-400">Quantity</p>
      ...
      <div className="mt-32 mb-12">
        <div className="flex items-center justify-between mb-10">
          <h3 className="text-2xl md:text-3xl font-black text-[#0d1b10]">You Might Also Like</h3>
          <div className="flex gap-3">
            <button className="size-12 rounded-full border-2 border-gray-200 hover:border-primary hover:text-primary flex items-center justify-center transition-colors text-gray-400">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {relatedProducts.map((item, idx) => (
            <Link to="/product/1" key={idx} className="flex flex-col gap-4 group cursor-pointer bg-white p-4 rounded-3xl border border-transparent hover:border-gray-100 hover:shadow-xl transition-all">
              ...
              <div className="px-2">
                <div className="flex justify-between items-start mb-1">
                  <h4 className="text-lg font-black group-hover:text-primary transition-colors text-[#0d1b10]">{item.name}</h4>
